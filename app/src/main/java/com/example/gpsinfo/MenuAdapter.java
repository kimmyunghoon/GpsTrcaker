...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_menu = (TextView) convertView.findViewById(R.id.tv_contents);
        ...
        tv_menu.setText(myItem.getMenu());
    ...
    public void addItem(Drawable img, String menu) {
